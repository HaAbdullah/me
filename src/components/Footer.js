  ...
  return (
    <div id="footer">
      <div className="left-side">
        Built and designed by Abdullah Hasanjee<br />
        All rights reserved. ©
      </div>
      <button id="scrollToTop" onClick={scrollToTop}>
        <FontAwesomeIcon icon={faCircleUp}  className='up' />
      </button>
      <div className="right-side">
        {/* Email icon */}
        <a href="mailto:abdullah.hasanjee@gmail.com" target="_blank" rel="noopener noreferrer">
          <svg className="hoverIconFooter" xmlns="http://www.w3.org/2000/svg" width="33" height="29" viewBox="0 0 33 29" fill="none">
        ...
        <a href="https://github.com/HaAbdullah" target="_blank" rel="noopener noreferrer">
          <svg className="hoverIconFooter" xmlns="http://www.w3.org/2000/svg" width="28" height="29" viewBox="0 0 28 29" fill="none">
        ...
        <a href="https://www.linkedin.com/in/abdullah-hasanjee-114a01225/" target="_blank" rel="noopener noreferrer">
          <svg className="hoverIconFooter" xmlns="http://www.w3.org/2000/svg" width="27" height="29" viewBox="0 0 27 29" fill="none">
