      ...
      <div className="carousel-container">
        <Carousel activeIndex={index} onSelect={handleSelect} interval={null}>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <h3>KeyWe</h3>
              <h2>A chrome extension that allows users to associate websites with unique code words facilitating a seamless browsing experience. </h2>
              <div className="skills-section">
                <p>HTML/CSS, JavaScript, Chrome Storage API</p>
                <a href={githubURLs[2]} target="_blank" rel="noopener noreferrer">
                  {GitHubLogo}
                </a>
